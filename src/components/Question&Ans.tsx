  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen md:pb-12">
      ...
      <div className="w-full max-w-3xl mt-12 px-4">
        <h2 className="md:text-3xl text-[1.6rem] font-bold mb-6 text-center" style={{ fontFamily: 'Playfair Display, serif' }}>Your Questions, Answered!</h2>
        ...
        {faqItems.map((item, index) => (
          <div key={index} className="mb-4 border border-gray-300 rounded-2xl shadow-md">
            ...
            {activeIndex === index && (
              <div className="px-4 pb-4 text-gray-700 bg-gray-100 rounded-b-2xl">
                {item.answer}
              </div>
            )}
          </div>
